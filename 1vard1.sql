...
INSERT INTO department (department_id, department_name, manager_id) VALUES
  ...
  -- extra departments
  (4, 'Industrial Engineering and Management', NULL),
  (5, 'Information Science', NULL);
...
INSERT INTO employee (
  ...
  -- extra employees
  (8, 500013, 'Sara', 'Johansson', 'sara.johansson@kth.se', '+46-70-7777777', 620000.00, 1, 1, 1),
  (9, 500014, 'Omar', 'Ali', 'omar.ali@kth.se', '+46-70-8888888', 580000.00, 1, 2, 1),
  (10, 500015, 'Anna', 'Berg', 'anna.berg@kth.se', '+46-70-9999999', 780000.00, 1, 3, 2);

-- 4. UPDATE DEPARTMENT MANAGERS
UPDATE department SET manager_id = 1 WHERE department_id IN (1,2,3,4,5);
...
INSERT INTO salary_history (salary_history_id, valid_from, valid_to, hourly_rate, employee_id) VALUES
  ...
  -- extra salary histories
  (8, DATE '2023-01-01', NULL,               510.00, 8),  -- Sara
  (9, DATE '2023-01-01', NULL,               490.00, 9),  -- Omar
  (10, DATE '2023-01-01', NULL,              610.00, 10); -- Anna
...
INSERT INTO course (course_code, course_name, hp, min_students, max_students, department_id) VALUES
  ...
  -- extra courses
  ('IX1600', 'Linear Algebra for Computer Science', 7.50, 50, 180, 2),
  ('DD2000', 'Algorithms and Data Structures',     7.50, 40, 200, 1);
...
INSERT INTO course_layout (
  ...
  -- extra layouts
  (6, 'IX1600',  7.50, 50, 180, DATE '2025-01-01', NULL,               'IX1600-2025'),
  (7, 'DD2000',  7.50, 40, 200, DATE '2025-01-01', NULL,               'DD2000-2025');
...
INSERT INTO course_instance (
  ...
  -- extra course instances (note: help Query 4: > N courses in P1)
  ('2025-70001', 2025, 140, 'IX1600', 'P1', 6),
  ('2025-70002', 2025, 160, 'DD2000', 'P2', 7),
  ('2025-70003', 2025, 110, 'IX1600', 'P3', 6);
...
-- IX1600 (2025-70001, P1) - extra; make Niharika teach 2 P1 courses for Query 4
INSERT INTO teaching_allocation (allocation_id, allocated_hours, employee_id, course_instance_id, activity_type_id) VALUES
  (28,36, 4, '2025-70001', 1),
  (29,24, 4, '2025-70001', 3),
  (30,20, 4, '2025-70001', 2),
  (31,30, 4, '2025-70001', 4),
  (32,60, 4, '2025-70001', 6),
  (33,40, 4, '2025-70001', 5),

  -- also allocate Sara and Omar to this instance
  (34,20, 8, '2025-70001', 1),
  (35,30, 9, '2025-70001', 3);

-- DD2000 (2025-70002, P2) - extra
INSERT INTO teaching_allocation (allocation_id, allocated_hours, employee_id, course_instance_id, activity_type_id) VALUES
  (36,40, 8, '2025-70002', 1),
  (37,30, 8, '2025-70002', 3),
  (38,10, 8, '2025-70002', 2),
  (39,20, 9, '2025-70002', 4),
  (40,50, 9, '2025-70002', 7),
  (41,30,10, '2025-70002', 5);

-- IX1600 (2025-70003, P3) - extra
INSERT INTO teaching_allocation (allocation_id, allocated_hours, employee_id, course_instance_id, activity_type_id) VALUES
  (42,28, 8, '2025-70003', 1),
  (43,18, 8, '2025-70003', 3),
  (44,12, 9, '2025-70003', 2),
  (45,24,10, '2025-70003', 4),
  (46,40,10, '2025-70003', 7),
  (47,30,10, '2025-70003', 5);
